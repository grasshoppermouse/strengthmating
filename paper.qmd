...
Our methods and models will remain identical to those reported in the pilot study, using unobserved data from the 2013-2014 NHANES collection cycle. After testing and reporting our predictions using the unobserved data, we will fit our models on the combined data (2011-2014), and conduct other post hoc analyses.
