...
## Discussion
The purpose of this study was to replicate as closely as possible, the results from @lassek2009, in new data that used combined grip strength as a proxy for upper body strength. Unlike @lassek2009, we included women to test if the effects of upper body strength on mating success were greater for men than women, as predicted by the sexual selection hypothesis. We also included numerous additional control variables, and used a registered report format with pre-specified models developed using pilot data in Stage 1 and then fit on held-out data in Stage 2. 
