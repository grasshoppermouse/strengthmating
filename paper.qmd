...
Theory and evidence suggest that the mating benefits of muscle mass in human males trade off with costs of increased energy intake and decreased measures of native immunity, likely due to an evolutionary history of sexual selection. It is unknown if females experience a similar tradeoff. Using data from the 2013-2014 phase of the National Health and Nutrition Examination Survey (NHANES), a large nationally representative sample of the US (N = 4384), we tested the prediction from the sexual selection hypothesis that the effect of upper body strength, proxied by grip strength, on mating success is significantly positive for males and significantly less so for females. We found a main effect of strength on mating success proxied by lifetime number of sexual partners and current partnership status, but not past year number of sexual partners or age at first intercourse, for both males and females. We found consistent evidence for a sex:strength interaction on partnered status, such that strength was significantly more important for male partnered status than female. Our results produced mixed evidence for a sex:strength interaction on lifetime number of sexual partners. We also tested for tradeoffs of strength with immune and dietary intake and found a positive relationship between strength and protein intake but no relationship with energy intake, and a negative relationship between grip strength and native immune function. This study replicates an earlier study of US men (Lassek & Gaulin, 2009) with numerous additional control variables, and the expansion of these models to include women.
...
CHECK: remind me why we are not using strength centered by sex here. 
...
CHECK: moved limitations section to confirmatory discussion. 
<!-- ## Limitations -->
...
We also discovered that because we included dietary energy intake in the expanded controls immune model we needed to utilize the weights calculated for the dietary data rather than the weights calculated for other data for this model. This is corrected in the confirmatory results for that model. CHECK: retroactively correct for pilot results? 
