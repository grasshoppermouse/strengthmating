...
tt(df_pwr) |>
  ...
  style_tt(i=1:4, j=2:7, color = v)
```

Power to detect strength and sex X strength coefficients that range from 25% to 100% of the size seen in the pilot study. **Scale**: the proportion of the effect seen in the pilot study. All other values are power (1-B). Values rounded to two significant digits. Red: power > 0.80.
:::
